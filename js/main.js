...
var config = function () {
	...
	return {
		...
		dialogue: [{ type: 6, name: '小许同学', txt: '摸鱼啊！小张老师' }, { type: 2, name: '小张老师', txt: '哎呀，又被领导熊了，今天摸不了鱼了。' }, { type: 2, name: '小许同学', txt: '你看我天天完不成领导交给的任务' }, { type: 2, name: '小许同学', txt: '不还照样摸鱼嘛!' },{ type: 6, name: '小张老师', txt: '不开心。' }, { type: 6, name: '小许同学', txt: '那我请你看一场烟花吧!' },{ type: 2, name: '小张老师', txt: '!@#$%^&*(也不知道说了啥！)' }],
		// 阶段二
		sunset: 8000,
		...
		//开心一点别烦心，柳暗之后定会花明
		fireWords: '开心一点|别烦心|柳暗之后|定会花明|淡然一点|别忧心|车到山前|必有路径|你要用心一点|别躁心|阳光|总在风雨后|小张老师|不要灰心|不要闹心|用心|经营生活吧',
		// hue:210 lightness 0
